...
// Hero Section
const HeroSection = () => (
  <section className="relative min-h-screen flex items-end pb-20 md:pb-32" data-testid="hero-section">
    {/* Background Image */}
    ...
    <div className="relative z-10 px-6 md:px-12 lg:px-24 max-w-7xl">
      ...
      >
        <span className="font-mono text-xs tracking-ultra-wide text-gold-400 uppercase mb-4 block">
          WTF Agency presenta
        </span>
    ...
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
        ...
        <div className="md:col-span-5">
          <motion.span variants={fadeInUp} className="font-mono text-xs tracking-ultra-wide text-gold-400 uppercase mb-4 block">
            01 — Diagnóstico
          </motion.span>
...
const InvestmentSection = () => (
  <AnimatedSection className="py-24 md:py-40 px-6 md:px-12 lg:px-24 relative overflow-hidden" id="inversion">
    ...
    <div className="absolute inset-0 z-0 opacity-10">
      <img 
        src="https://images.unsplash.com/photo-1736506159893-22cca29b8018?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2OTV8MHwxfHNlYXJjaHw0fHxjcmFmdHNtYW4lMjBjYXJ2aW5nJTIwd29vZCUyMHdpbmUlMjBiYXJyZWwlMjBkYXJrJTIwbW9vZHl8ZW58MHx8fHwxNzc0MDE1OTcwfDA&ixlib=rb-4.1.0&q=85"
        alt="Wood texture"
        className="w-full h-full object-cover"
      />
    </div>
    ...
    <div className="max-w-7xl mx-auto relative z-10">
      <div className="text-center">
        <motion.span variants={fadeInUp} className="font-mono text-xs tracking-ultra-wide text-gold-400 uppercase mb-6 block">
          04 — Inversión
        </motion.span>
